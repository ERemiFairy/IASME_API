...
array(
	...
	'score'=> '', 
	'Address Line 1'=>'3 Training Street',
	'Postcode'=>'TR11NG',
	'answer'=> 'UK',
...
array(
	...
	"answer"=> "Office is based in London. When working from home, all users are based in the
	UK",
	"score"=> ""
),
array(
	...
	"answer"=> "We have 13 devices in total as per the following OS specifications:
		- 6 x Windows 11 Pro 22H2 - 5 x Windows 10 Pro 22H2 - 2 x macOS Sonoma",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "All corporate and BYOD devices are required to have software firewalls installed and enabled at all times. Both types of devices are managed by our IT provider who ensures software firewalls and AV are installed, up to date and are properly configured.",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "As per our IT security policy, we follow the steps mentioned below to change default firewall/router passwords prior to deployment:
	- The Information security manager logs onto the administrator panel of the firewall/router.
	- Navigate to 'System Maintenance' > 'Admin password' on the panel.
	- Changes the default password to a strong/unique password which has a minimum character length of 12 characters which is in line with the policy.",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "Yes. Our IT support company sets up a fresh install of OS with only required software on all new systems. Existing systems get reviewed by the IT support company at least quarterly to ensure only software that is used is present.",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "All users are required to set up a complex password of 12+ characters, a 6-digit plus PIN or use biometrics.",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "MS Edge v118 Google Chrome v118",
	"score"=> ""
),
array(
	"id"=> "723f090df18af67712d8c14ce2bef449e892f679f490eefadc9bc5ea05850297",
	"name"=> "A6.2.2 Malware Protection",
	"answer"=> "Xprotect version 2174 for macs, Windows Defender (versions below):
		Antimalware Client Version: 4.18.23090.2008 Engine Version: 1.1.23090.2007 Antivirus Version: 1.399.1664.0 Antispyware Version: 1.399.1664.0",
	"score"=> ""
),
array(
	"id"=> "a84b2f56a294f8ed7e857fef17944ddcf7ade7f02204692a2b46901c5cc32113",
	"name"=> "A6.2.3 Email Application",
	"answer"=> "Outlook version 2310, Current Channel",
	"score"=> ""
),
array(
	"id"=> "371ed01013bb7960cd334ed37e53ee0f6e3af3cd51743f8c7e1ec3f6fc96482d",
	"name"=> "A6.2.4 Office Applications",
	"answer"=> "MS 365 Apps for Business version 2310, Current Channel",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "We run a bi-weekly vulnerability scan Tenable.io on all its devices every 14 days. Any vulnerabilities, including missing patches on OS and applications are resolved the same day by our inhouse security team.
	Our BYOD Policy also requires that mobile users update their devices within 7 days of update release. This is regularly checked manually.",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "Unsupported software is not used.",
	"score"=> ""
),
array(
	"id"=> "080b59be96af5b46fdf79f8e0282f387f6c98d2345e795a4f08e9a2cd24d5566",
	"name"=> "A7.1 User Account Creation",
	"answer"=> "Yes. New users are only given accounts by the IT support company if HR raises a ticket with such a requirement. This process has to be approved by the Director according to our IT Security Policy.",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "On the leavers last day HR raises a ticket with the IT support company who remotely disable all accounts associated with the user.",
	"score"=> ""
),
array(
	"id"=> "8e20ae5172b2f0d88f9d0a5f29ac055aea6ad91bd58d45e562be8de169bf3a33",
	"name"=> "A7.4 User Privileges",
	"answer"=> "Yes. Privileges are requested from the Director who then either raises a ticket or instructs HR to raise a ticket with the IT support company for appropriate level of privileges. The log of accounts is kept in accordance with our IT Security Policy.",
	"score"=> ""
),
array(
	"id"=> "5866bbf99966ee5d5d57aceed7cf776753d7184152858052fd7a5547849ea414",
	"name"=> "A7.5 Administrator Approval",
	"answer"=> "Yes. Admin access is requested from the Director who then either raises a ticket or instructs HR to raise a ticket with the IT support company for appropriate level of privileges. The log of accounts is kept in accordance with our IT Security Policy.",
	"score"=> ""
),
array(
	"id"=> "a47a0bbb605702be2935d3b7662a903d796ecef47baa83904e49f8323fed00fa",
	"name"=> "A7.6 Use of Administrator Accounts",
	"answer"=> "Each device has a separate admin account for administrative tasks. Our Acceptable Usage Policy states that admin accounts are to be used exclusively for administrative tasks such as installing software and with explicit permission from Director or our Information Security manager.",
	"score"=> ""
),
array(
	"id"=> "31b3b0abd4ef2f7c41d4deed0ce219347ee6d628ec3632838b9d916591562bdb",
	"name"=> "A7.7 Managing Administrator Account Usage",
	"answer"=> "Our Acceptable Usage Policy states that admin accounts are to be used exclusively for administrative tasks and forbids
	accessing email and web browsing while logged in into an administrative account. This is reinforced by yearly training .",
	"score"=> ""
),
array(
...
array(
	...
	"answer"=> "All devices and services that do not have MFA, have either a lock-out mechanism (after 10 unsuccessful attempts) or throttling in place, where each next log-in attempt is progressively delayed.",
	"score"=> ""
),
array(
	"id"=> "f41ce03885f7ebfe13354ea4a7a0453e84bc87ae46382ade674c705b40922dc1",
	"name"=> "A7.11 word Quality",
	"answer"=> "MFA is enforced for most devices and services. Where MFA is absent only a minimum password length of at least 12 characters, with no maximum length is accepted.",
	"score"=> ""
),
array(
	"id"=> "637c591224f354ff19ff323c7ca3b857b6a2ece63ebb93f0e4a22754a530c60f",
	"name"=> "A7.12 word Creation Advice",
	"answer"=> "All users receive password creation guidance during on-boarding and every year thereafter. All staff are required to take our information security online course and a quiz twice a year which outlines the following password requirements and recommendations:
		- use a password manager
		- use passwords of 12 characters or more, preferrable 24 characters which include capital letter, special characters and digits - password should not contain easily guessable information such as persons name, DOB, address, spouse/childrens information
		We also run quarterly phishing exercises, where results are reviewed and if weak credentials are captured, further training is provided.
		",
	"score"=> ""
),
array(
